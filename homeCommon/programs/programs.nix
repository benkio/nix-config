  ...
  programs = {
    ...
    wezterm = {
      ...
      extraConfig = ''
        ...
        config.font = wezterm.font_with_fallback { 'Iosevka', 'UbuntuMono Nerd Font', 'JetBrains Mono', 'Noto Sans Mono', 'DejaVu Sans Mono', 'monospace' }
