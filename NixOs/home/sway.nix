  ...
  wayland.windowManager.sway = {
    ...
    config = {
      ...
      startup = [
        ...
        {
          command = "\"sleep 1; awww-daemon & sleep 1; while true; do awww img ${config.home.homeDirectory}/wallpapers/$(ls ${config.home.homeDirectory}/wallpapers | shuf -n 1) --transition-fps 30 --transition-type=random --transition-bezier=0,0.84,1,1; sleep 600; done\"";
          always = false;
        }

        {
          command = "maestral autostart";
          always = false;
        }
      ];
      bars = [
